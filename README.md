...
-Clonar el proyecto en la carpeta htdocs de Xampp (Deveria quedar asi: "C:\xampp\htdocs\PPSUT5ProyectoTienda\...").
...
-Por ultimo, para acceder a la pagina, escribir en el buscador http://localhost:8080/PPSUT5ProyectoTienda/blackdeck/index.php.
